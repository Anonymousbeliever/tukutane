    ...
    <div class="min-h-screen bg-white text-gray-900 flex flex-col">
        ...
        <header class="absolute top-0 left-0 right-0 z-10 p-6 md:p-8 bg-transparent">
            <nav class="flex items-center justify-between max-w-7xl mx-auto">
                <div class="flex items-center">
                    <a href="{{ url('/') }}" class="text-3xl font-extrabold text-red-600">Tukutane</a>
                </div>
                <div class="flex items-center gap-6">
                    <a href="#about" class="text-gray-700 hover:text-red-600 transition-colors duration-200 text-lg font-medium">About</a>
                    <a href="#events" class="text-gray-700 hover:text-red-600 transition-colors duration-200 text-lg font-medium">Events</a>
                    <a href="#contact" class="text-gray-700 hover:text-red-600 transition-colors duration-200 text-lg font-medium">Contact</a>
                    @if (Route::has('login'))
                        @auth
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ml-4 text-gray-700 hover:text-red-600 transition-colors duration-200 text-lg font-medium">Register</a>
                            @endif
                        @endauth
                    @endif
                </div>
        ...
        <section class="relative flex items-center justify-center h-screen bg-gray-50 overflow-hidden">
            <div class="absolute inset-0">
                ...
                <div class="w-full h-full bg-gradient-to-br from-gray-100 to-gray-200 opacity-70"></div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-gray-50 p-8 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <svg class="h-12 w-12 text-red-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    ...
                    <div class="bg-gray-50 p-8 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <svg class="h-12 w-12 text-red-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                    ...
                    <div class="bg-gray-50 p-8 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition-all duration-300 ease-in-out">
                        <svg class="h-12 w-12 text-red-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h10m1 4H6a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2z"></path></svg>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition-all duration-300 ease-in-out">
                        ...
                        <a href="{{ route('login') }}" class="text-red-600 hover:text-red-500 font-medium">Learn More & RSVP &rarr;</a>
                    </div>
                    {{-- Event Card 2 --}}
                    <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-xl transition-all duration-300 ease-in-out">
        ...
        <footer id="contact" class="bg-gray-900 text-gray-300 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-xl font-bold text-white mb-4">Tukutane</h3>
                    <p class="text-gray-400">Connecting IST graduates, empowering futures.</p>
                </div>
                <div>
                    <h3 class="text-xl font-bold text-white mb-4">Quick Links</h3>
                    <ul class="space-y-2">
                        <li><a href="#about" class="hover:text-red-600 transition-colors duration-200">About Us</a></li>
                        <li><a href="#events-highlight" class="hover:text-red-600 transition-colors duration-200">Events</a></li>
                        <li><a href="{{ route('login') }}" class="hover:text-red-600 transition-colors duration-200">Login</a></li>
                        <li><a href="{{ route('register') }}" class="hover:text-red-600 transition-colors duration-200">Register</a></li>
                    </ul>
                </div>
                <div>
