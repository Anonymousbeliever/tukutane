<div id="sidebar" class="sidebar">
   <div class="sidebar-header">
       ...
       <button id="sidebar-toggle-close" class="md-hidden text-white-color hover:text-gray-200 focus:outline-none transition-colors duration-200">
   ...
   <nav class="space-y-2 sidebar-nav">
       ...
       @else {{-- Alumnus --}}
           ...
           <a href="{{ route('payments.pay') }}" class="{{ request()->routeIs('payments.pay') ? 'active' : '' }}">
               <svg class="h-6 w-6 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h10m-9 4h8a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
               Make Payment
           </a>
       @endif
